<template>
    <div class="container">
        <div class="card-header px-0 mt-2 bg-transparent clearfix">
            <h4 class="float-left pt-2">MNS</h4>
            <div class="card-header-actions mr-1">
                <a class="btn btn-success" href="/mns/create">New mns</a>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th>
                    <a href="#" class="text-dark" @click.prevent="sort('name')">MNS CODE</a>
                    ...
                    <th>
                    <a href="#" class="text-dark" @click.prevent="sort('name')">MNS TYPE</a>
                    <i class="mr-1 fas" :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'name' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'name' && filters.orderBy.direction == 'desc'}"></i>
                    </th>
                    <th>
                    <a href="#" class="text-dark" @click.prevent="sort('name')">QUARTER ID</a>
                    <i class="mr-1 fas" :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'name' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'name' && filters.orderBy.direction == 'desc'}"></i>
                    </th>
                    <th>
                    <a href="#" class="text-dark" @click.prevent="sort('name')">MNO ID</a>
                    <i class="mr-1 fas" :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'name' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'name' && filters.orderBy.direction == 'desc'}"></i>
                    </th>
                    <th>
                    <a href="#" class="text-dark" @click.prevent="sort('name')">PRE PAID</a>
                    <i class="mr-1 fas" :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'name' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'name' && filters.orderBy.direction == 'desc'}"></i>
                    </th>
                    <th>
                    <a href="#" class="text-dark" @click.prevent="sort('name')">POST PAID</a>
                    <i class="mr-1 fas" :class="{'fa-long-arrow-alt-down': filters.orderBy.column == 'name' && filters.orderBy.direction == 'asc', 'fa-long-arrow-alt-up': filters.orderBy.column == 'name' && filters.orderBy.direction == 'desc'}"></i>
                    </th>
                ...
                <tbody>
                <tr v-for="mobile in mns" v-bind="mobile.id" @click="editMns(mobile.id)" :key="mobile.id" >
                    <td class="d-none d-sm-table-cell">{{mns.id}}</td>
                    <td class="d-none d-sm-table-cell">{{mns.mns_code}}</td>
                    <td class="d-none d-sm-table-cell">{{mns.type}}</td>
                    <td class="d-none d-sm-table-cell">{{mns.quarter_id}}</td>
                    <td class="d-none d-sm-table-cell">{{mns.mno_id}}</td>
                     <td class="d-none d-sm-table-cell">{{mns.pre_paid}}</td>
                      <td class="d-none d-sm-table-cell">{{mns.post_paid}}</td>
            ...
            <div class="no-items-found text-center mt-5" v-if="!loading && !users.length > 0">
                ...
                <a class="btn btn-success" href="/mns/create" role="button">
                <i class="fa fa-plus"></i>&nbsp; New Mns
                </a>
            </div>
...
export default {
  ...
  mounted () {
    if (localStorage.getItem("filtersTableMns")) {
      this.filters = JSON.parse(localStorage.getItem("filtersTableMns"))
    } else {
      localStorage.setItem("filtersTableMns", this.filters);
    }
    this.getMns()
  },
  methods: {
    getMns () {
      ...
      localStorage.setItem("filtersTableMns", JSON.stringify(this.filters));

      axios.post(`/api/mns/filter?page=${this.filters.pagination.current_page}`, this.filters)
      .then(response => {
        this.mns = response.data.data
